 ...
 * @since JDK 1.8
 */
public class BatchTableExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 3.注册DataSet为表
        Table user = tableEnvironment.fromDataSet(userDataSet);
        // 4.查询表数据
        Table nameTable = user.select("career").distinct();
        // 5.将表转换为DataSet
        DataSet<String> resultDataSet = tableEnvironment.toDataSet(nameTable, String.class);
        resultDataSet.print();
    }
