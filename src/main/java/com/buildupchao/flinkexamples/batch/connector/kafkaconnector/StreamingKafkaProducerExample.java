package com.buildupchao.flinkexamples.batch.connector.kafkaconnector;
 ...
 * @since JDK 1.8
 */
public class StreamingKafkaProducerExample {
    ...
    public static void main(String[] args) {
        ...
        FlinkKafkaProducer09<String> kafkaProducer = new FlinkKafkaProducer09<>(topic, new SimpleStringSchema(), properties);
