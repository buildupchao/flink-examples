package com.buildupchao.flinkexamples.batch.faulttolerance;
 ...
 * @since JDK 1.8
 */
public class FaultToleranceBasedOnFailureRateExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 1小时中可以失败2次，两次失败重启尝试之间等待时间为10秒钟
        // 1小时中失败次数超过2次，任务将最终失败
        ...
        DataSet<String> dataSet = environment.fromElements("1", "2", "", "4", "5");
