package com.buildupchao.flinkexamples.common.constant;
...
public class PropertiesConstants {
    public static final String AUTHOR_NAME = "buildupchao";
    ...
    public static final String DEFAULT_KAFKA_GROUP_ID = "flinkexamples";
